...
# Inicializa o servidor Flask no IP 10.246.3.128 e porta 12000
if __name__ == '__main__':
    print("Iniciando o servidor Flask no IP 10.246.3.128 e porta 12000...")
    app.run(host='10.246.3.128', port=12000)
