...
def insert_wifi_data(connection, time, device_id, mac_address, hostname, signal_strength, packets_sent, packets_received, bytes_sent, bytes_received, erros_sent, erros_received, radio_connected, time_since_connected):
    query = sql.SQL("""
        INSERT INTO wifi_stats (time, device_id, mac_address, hostname, signal_strength, packets_sent, packets_received, bytes_sent, bytes_received, erros_sent, erros_received, radio_connected, time_since_connected)
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
    """)
    data = (time, device_id, mac_address, hostname, signal_strength, packets_sent, packets_received, bytes_sent, bytes_received, erros_sent, erros_received, radio_connected, time_since_connected)
        ...
        for key in keys:
            ...
            try:
                if prefix == 'redes_proximas;':
                    ...
                    _, time, device_id, mac_address, hostname, signal_strength, packets_sent, packets_received, bytes_sent, bytes_received, erros_sent, erros_received, radio_connected, time_since_connected = key.split(";")
                    insert_wifi_data(connection_bulkdata, time, device_id, mac_address, hostname, signal_strength, packets_sent, packets_received, bytes_sent, bytes_received, erros_sent, erros_received, radio_connected, time_since_connected)
                elif prefix == 'dados;' :
